...
require_once('modules/Import/sources/ImportFileXls.php');
...
class ImportViewConfirm extends ImportView
{
 	...
 	public function display()
    {
        ...
        $importFile = new ImportFileXls( $uploadFileName, $_REQUEST['custom_delimiter'], html_entity_decode($_REQUEST['custom_enclosure'],ENT_QUOTES), FALSE);
